...
def main():
    ...
    copilot_taskbar_key_value = 0

    # Set registry keys
    if set_registry_key_value(copilot_taskbar_key_path, copilot_taskbar_key_name, copilot_taskbar_key_type, copilot_taskbar_key_value) and \
       set_registry_key_value(bingchat_key_path, bingchat_key_name, bingchat_key_type, bingchat_key_value) and \
         set_registry_key_value(copilot_key_path, copilot_key_name, copilot_key_type, copilot_key_value):
